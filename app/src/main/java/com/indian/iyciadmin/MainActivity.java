...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        senderIdEditText = findViewById(R.id.senderId);
        sendNotificationButton = findViewById(R.id.sendButton);
        updateButton = findViewById(R.id.updateButton);
        senderIdTv = findViewById(R.id.senderIdTv);
        totaluserTv = findViewById(R.id.totaluserTv);
    ...
    private void uploadNotification() {
        ...
        mDatabaseRef.child(uploadId).setValue(uploadNotification).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(MainActivity.this, "Notification Uploaded", Toast.LENGTH_SHORT).show();
